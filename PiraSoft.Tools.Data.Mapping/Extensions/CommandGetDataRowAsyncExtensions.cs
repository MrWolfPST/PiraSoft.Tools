...
{
    /// <summary>
    /// This is the asynchronous version of <see cref="CommandGetDataRowExtensions.Get{T, TDataReader, TParameter}(Command{TDataReader, TParameter}, Func{T})"/>.
    /// </summary>
    ...
    /// <summary>
    /// This is the asynchronous version of <see cref="CommandGetDataRowExtensions.Get{T, TDataReader, TParameter}(Command{TDataReader, TParameter}, Func{T}, TypeMappings?)"/>
    /// </summary>
    /// <typeparam name="TDataReader">The type of data reader.</typeparam>
    /// <typeparam name="TParameter">The type of parameters.</typeparam>
    ...
    /// <summary>
    /// This is the asynchronous version of <see cref="CommandGetDataRowExtensions.Get{T, TDataReader, TParameter}(Command{TDataReader, TParameter})"/>
    /// </summary>
    ...
    /// <summary>
    /// This is the asynchronous version of <see cref="CommandGetDataRowExtensions.Get{T, TDataReader, TParameter}(Command{TDataReader, TParameter}, TypeMappings?)"/>
    /// </summary>
    /// <typeparam name="T">Type of the object to return. The type must be implement a parameterless constructor.</typeparam>
    /// <typeparam name="TDataReader">The type of data reader.</typeparam>
    /// <typeparam name="TParameter">The type of parameters.</typeparam>
